...
variable {k V : Type*} [LinearOrderedField k] [CharZero k] [AddCommGroup V] [Module k V]
...
theorem fd {k V : Type*} [LinearOrderedField k] [CharZero k] [AddCommGroup V] [Module k V]
