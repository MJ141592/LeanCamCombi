...
structure IsReducedRootSystem (k : Type*) {V : Type*} [CommRing k] [CharZero k] [AddCommGroup V]
...
theorem foo {k : Type*} {V : Type*} (n m : ℤ) [Field k] [CharZero k] [AddCommGroup V] [Module k V]
...
theorem m_not_neg_1 {k : Type*} {V : Type*} (n m : ℤ) [Field k] [CharZero k] [AddCommGroup V]
