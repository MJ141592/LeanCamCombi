...
structure IsBase {k V ι : Type*} [LinearOrderedField k] [AddCommGroup V] [Module k V] {Φ : Set V}
...
variable {k : Type*} {V : Type*} [LinearOrderedField k] [AddCommGroup V] [Module k V]
